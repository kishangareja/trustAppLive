            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="catediv">
                        ...
                        {{-- searchbox start --}}
                        <div class="searchbox" style="display: none;display:flow-root!important;"> 
                            ...
                            <div class="row no-gutters" >
                                <div class="col-5">
                                 ...
                                 <div class="col-6 text-center">
                                     <button onclick="getLocation()" class="locationBtn text-center btn text-white" style="font-size: 14px !important;border:white solid 2px;height:34px;">Current Location</button> 
                                </div>
                            </div>                         
