            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="catediv">
                        ...
                        {{-- searchbox start --}}
                        <div class="searchbox" style="display: none;display;justify-content: space-around;"> 
                            ...
                            <div class="row no-gutters" >
                                <div class="col-5">
                                 ...
                                 <div class="col-6 text-center">
                                     <button onclick="getLocation()" class="text-center btn btn-warning" style="font-size: 14px !important;height:34px;background-color: #ffc107!important;">Current Location</button> 
                                </div>
                            </div>                         
